...
function Edit() 
{
    ...
    var iCompletestackId = window.location.pathname.substring(window.location.pathname.lastIndexOf('/') + 1);
    ...
    const answer_array = answer.split('/');
    if (answer_array[2] == 'localhost:3000') {
        var urls = `http://localhost/compeletestack/backend/api/all_image_get?iCompletestackId=${iCompletestackId}`;
    }
    else {
        var urls = `https://compeletestack.justcodenow.com/backend/api/all_image_get?iCompletestackId=${iCompletestackId}`;
    }
    ...
    useEffect(() => {
        axios.get(urls)
            .then(res => {
                ...
                setDesc(res.data.data.vDesc);
                setImage(res.data.data.vImage);
                setImage1(res.data.data.vImage1);
                setImage2(res.data.data.vImage2);
                setImage3(res.data.data.vImage3);
                setImage4(res.data.data.vImage4);
                setImage5(res.data.data.vImage5);
                                    ...
                                    <div className="card">
                                        <div className="card-header border-0">
                                            <div className="row align-items-center">
                                                <div className="col">
                                                    <h3 className="mb-0">Image Content information </h3>
                                                    ...
                                                    <div className="row">
                                                        ...
                                                        <div className="col-lg-6">
                                                            <div className="form-group">
                                                                ...
                                                                <img src={Image1} className="img11 h-101" />
                                                                {
                                                                    Image1 ?
                                                                        <>
                                                                            <span className="red"></span>
                                                        ...
                                                        <div className="col-lg-6">
                                                            <div className="form-group">
                                                                ...
                                                                <img src={Image2} className="img2 h-101" />
                                                                {
                                                                    Image2 ?
                                                                        <>
                                                                            <span className="red"></span>
                                                        ...
                                                        <div className="col-lg-6">
                                                            <div className="form-group">
                                                                ...
                                                                <img src={Image3} className="img3 h-101" />
                                                                {
                                                                    Image3 ?
                                                                        <>
                                                                            <span className="red"></span>
                                                        ...
                                                        <div className="col-lg-6">
                                                            <div className="form-group">
                                                                ...
                                                                <img src={Image4} className="img4 h-101" />
                                                                {
                                                                    Image4 ?
                                                                        <>
                                                                            <span className="red"></span>
                                                        ...
                                                        <div className="col-lg-6">
                                                            <div className="form-group">
                                                                ...
                                                                <img src={Image5} className="img5 h-101" />
                                                                {
                                                                    Image5 ?
                                                                        <>
                                                                            <span className="red"></span>
                                                        ...
                                                        <div className="col-lg-6">
                                                            <div className="form-group">
                                                                ...
                                                                <textarea onChange={(e) => setDesc(e.target.value)} id="vDescription" rows="4" className="form-control" placeholder="Description..." value={Desc}></textarea>
                                                        ...
                                                        <div className="col-lg-12 mt-5">
                                                            <div className="form-group">
                                                                <button type="button" onClick={savedata} className="Btn ">
                                                                    Submit
                                                                </button> &nbsp;&nbsp;&nbsp;
